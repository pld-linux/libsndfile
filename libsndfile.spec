...
%description -l pl
Libsndfile to bibliotek╠ napisan╠ w C, sЁu©╠ca do czytania i
zapisywania plikСw zawieraj╠cych zsamplowany d╪wiЙk (np. w formacie MS
...
Pliki nagЁСwkowe oraz dokumentacja do biblioteki libsndfile.
